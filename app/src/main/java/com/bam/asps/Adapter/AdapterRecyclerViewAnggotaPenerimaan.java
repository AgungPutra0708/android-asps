...
public class AdapterRecyclerViewAnggotaPenerimaan extends RecyclerView.Adapter<AdapterRecyclerViewAnggotaPenerimaan.ViewHolder> {
...
//    private ArrayList<ModelAnggota> dataItem1;
    ...
    public AdapterRecyclerViewAnggotaPenerimaan(Context context, ModelAnggotaPenerimaan[] data){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_penerimaan_anggota,parent,false);
...
//            Toast.makeText(context,data[position].getNama_anggota(),Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(context, PenerimaanInputActivity.class);
