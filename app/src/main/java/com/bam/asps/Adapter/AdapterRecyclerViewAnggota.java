...
import com.bam.asps.KreditDataAnggota;
import com.bam.asps.Model.ModelAnggota;
import com.bam.asps.R;

public class AdapterRecyclerViewAnggota extends RecyclerView.Adapter<AdapterRecyclerViewAnggota.ViewHolder> {
...
//    private ArrayList<ModelAnggota> dataItem1;
    ...
    public AdapterRecyclerViewAnggota(Context context, ModelAnggota[] data){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_kredit_anggota,parent,false);
...
//            Toast.makeText(context,data[position].getNama_anggota(),Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(context, KreditDataAnggota.class);
