...
public class AdapterRecyclerViewRembugPenerimaan extends RecyclerView.Adapter<AdapterRecyclerViewRembugPenerimaan.myviewholder> {

    ModelRembugPenerimaan data[];
    ConstraintLayout parentLayout;
    SessionManager sessionManager;
    private Context context;

    public AdapterRecyclerViewRembugPenerimaan(Context context, ModelRembugPenerimaan[] data) {
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_penerimaan_rembug,parent,false);
...
//            Toast.makeText(context,data[position].getId_rempug(),Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(context, PenerimaanAnggotaActivity.class);
