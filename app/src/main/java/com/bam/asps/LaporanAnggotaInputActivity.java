...
public class LaporanAnggotaInputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laporan_anggota_input);
    ...
    public void convertXmlToPdf() {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.activity_laporan_anggota_input, null);
