...
public class ModelRembug {
    String id_rempug,kode_cabang,kode_kota,kode_kec,kode_kel,kode_rempug,nama_rempug,jmlhanggota;

    public ModelRembug() {
    }

    public ModelRembug(String id_rempug, String kode_cabang, String kode_kota, String kode_kec, String kode_kel, String kode_rempug, String nama_rempug, String jmlhanggota) {
