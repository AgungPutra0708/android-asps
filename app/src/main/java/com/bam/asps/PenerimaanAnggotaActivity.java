...
public class PenerimaanAnggotaActivity extends AppCompatActivity {

    RecyclerView recyclerView;
    AdapterRecyclerViewAnggotaPenerimaan recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_penerimaan_anggota);
    ...
    public void processdata(String rembug){
        StringRequest request = new StringRequest(Request.Method.POST, DbContract.GET_DATA_ANGGOTA_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                AdapterRecyclerViewAnggotaPenerimaan adapter = new AdapterRecyclerViewAnggotaPenerimaan(PenerimaanAnggotaActivity.this,data);
