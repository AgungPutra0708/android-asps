...
public class PenerimaanRembugActivity extends AppCompatActivity {

    RecyclerView recyclerView;
    AdapterRecyclerViewRembugPenerimaan recyclerViewAdapter;
    SessionManager sessionManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_penerimaan_rembug);
    ...
    public void processdata(String cabang){
        StringRequest request = new StringRequest(Request.Method.POST, DbContract.GET_DATA_REMBUG_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                ModelRembugPenerimaan data[] = gson.fromJson(response, ModelRembugPenerimaan[].class);

                AdapterRecyclerViewRembugPenerimaan adapter = new AdapterRecyclerViewRembugPenerimaan(PenerimaanRembugActivity.this,data);
